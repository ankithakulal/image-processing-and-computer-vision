...
def apply_sobel(image):
    ...
    sobely = cv2.Sobel(image, cv2.CV_64F, 0, 1, ksize=3)  # Corrected 'sobel' to 'Sobel'
...
def main():
    ...
    cv2.waitKey(0)  # Corrected 'WaitKey' to 'waitKey'
    cv2.destroyAllWindows()

if __name__ == "__main__":  # Corrected the indentation
    main()
